...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        try:
            ...
            user_name   = s(data.get('name') or "resume")
            ...
            if file_format == 'pdf':
                ...
                if any(job.get('jobTitle') for job in work_list):
                ...
                if any(edu.get('degree') for edu in edu_list):
            ...
            # Log on server and return JSON error (frontend already handles this)
            try:
